-- Function fetches all the files needed to setup jdtls
...
-- Helper function to setup test and debug adapter
...
-- Function creates project directory in workspace to store project information
local function get_workspace()
  local home = os.getenv "HOME"
  local workspace_path = home .. "/programming/workspace/"
  local project_name = vim.fn.fnamemodify(vim.fn.getcwd(), ":p:h:t")
  local workspace_dir = workspace_path .. project_name
  return workspace_dir
end

-- sets keymaps for jdtls functionalities
